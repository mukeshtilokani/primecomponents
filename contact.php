...
<div class="main-container col2-right-layout">
	<div class="main container">
		<div class="row">
			...
			<aside class="col-right sidebar col-sm-4 wow bounceInUp animated">
				<div class="block block-company">
					...
					<div class="block-content" style="padding: 15px !important;">
						...
						<p style="color: #333;margin-left:62px;" >830, GIDC Estate</br>
						Makarpura, Vadodara</br>
						Gujarat, India</br>
						Pin : 390010</p>
						<p class="button"><i class="icon-mobile-phone">&nbsp;</i> PHONE</p>
						<p style="color: #333;margin-left:62px;">0265-6642566 </br> +91 90990 56200</p>
						<p class="button"><i class="icon-envelope">&nbsp;</i> EMAIL</p>
						<p style="color: #333;margin-left:62px;"><strong>Sales/Inquiry :</strong></br> sales@primecomponents.net</p>
						<p style="color: #333;margin-left:62px;"><strong>Account :</strong></br> dimple@primecomponents.net</p>
						<p style="color: #333;margin-left:62px;"><strong>Purchase :</strong></br> chirayu@primecomponents.net</p>
						<p style="color: #333;margin-left:62px;"><strong>Technical :</strong></br> rajan@primecomponents.net</p>
