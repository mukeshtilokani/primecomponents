...
<div class="main-content">
  <div id="container" class="wrap-content container"> 
    ...
    <section id="page-title">
      <div class="row">
        <div class="col-sm-8">
          <h1 class="mainTitle">Manage Home Banners
	          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	          <a class="btn btn-primary" href="<?=SITEURL?>views/homebanners/frmHomeBanners.php" >Add New</a>
          </h1>
        </div>
        <ol class="breadcrumb">
          <li> <span>Dashboard</span> </li>
          <li class="active"> <span>Manage Home Banners</span> </li>
        </ol>
      </div>
    </section>
    <!-- end: PAGE TITLE -->
              ...
              <div class='tab-pane fade active in' id="myTab1_example1">
                <div class="row">
                  <?php
                                            ...
                                            $sql2 = $dbh->prepare("SELECT * FROM home_banners");
                                            $sql2->execute();
                                            $rows2 = $sql2->fetchAll();
                  ...
                  <div class="col-xs-6 col-md-3" style="text-align: center" > <a href="#" class="thumbnail">
                          <img src="<?=SITEURLFRONT ?>images/homebanners/<?= $rows2[$k]['hi_image'] ?>"> </a>
                    <p>
                      <button class="btn btn-danger btnDelete" data-src="<?= $rows2[$k]['hi_image'] ?>"
                                                                data-id="<?= $rows2[$k]['hi_id'] ?>"
            ...
            function(isConfirm){
                if (isConfirm) {
                    $.ajax({
                        ...
                        url:'../../api/homebanners/deleteImage.php',
