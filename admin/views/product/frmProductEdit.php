<?php
	...
	if ( isset( $_SESSION['wf_id'] ) && $_SESSION['wf_id'] != '' ) {
			...
			<div id="container" class="wrap-content container"> <!-- start: PAGE TITLE -->
				...
				<div class="container-fluid container-fullw bg-white">
											...
											<div class="row">
												...
												<div class="col-md-5">
													...
													<div class="form-group">
														...
														<label class="control-label"> Product Code / Name <span
													...
													<div class="form-group">
														...
														<label class="control-label"> Series<span
													...
													<div class="col-md-12">
														...
														<div class="form-group">
															...
															<label> <a class="btn btn-success"
															           id="btnViewImages"><strong> <i
																			class="fa fa-picture-o"
																			title="Click to view Product Images"
																			style="font-size: 30px;"></i> Uploaded
																		Images </strong> </a></label>
															...
															<input type="hidden" id="p_imageNameOld"
															       name="p_imageNameOld"
                    ...
                    <textarea cols="10" rows="5" id="p_order_info" style="width:100%"
                              ...
                              name="p_order_info">                                                <?= trim( urldecode( $rows[ $i ]['p_order_info'] ) ) ?>

</textarea>

														<?php $p_order_info = trim( urldecode( $rows[ $i ]['p_order_info'] ) ); ?>
		...
		<!-- Large Modal -->
		<div id="modal-7" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
...
<script>
	...
	jQuery(document).ready(function () {
		...
		$('#btnViewImages').on('click', function () {
