			  ...
			  <fieldset>
				...
				<div class="row">
				  <div class="col-md-4">
					...
					<div class="form-group">
					  <label class="control-label"> Product Name <span class="symbol required" aria-required="true"></span> </label>
					...
					<div class="form-group">
					  <label class="control-label"> Product Code <span class="symbol required" aria-required="true"></span> </label>
					  <input type="text" placeholder="Product Code" class="form-control"   id="p_code" name="p_code" >
					</div>
					<div class="form-group">
