                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Category Name" class="form-control"
                                           id="pc_title" name="pc_title"
                                           onblur="printAlias()" onKeyPress="printAlias()" onKeyUp="printAlias()"
                                           value="<?=urldecode($rows[$i]['pc_title'])?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="<?=SITEURLFRONT?>images/cat/thumb/<?=$rows[$i]['pc_image']?>" alt="""/> <br>
                                    <label>
                                        Replace Image
                                    </label>
                                     <input id="pc_image" name="pc_image" type="file" accept="image/*" class="file-loading" >
                                    <input type="hidden" id="pc_imageName" name="pc_imageName" value="<?=$rows[$i]['pc_image']?>" />
...
<!--                                    </div>-->
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="ckeditor form-control" cols="10" rows="10"  id="pc_desc" name="pc_desc"
                                              value="<?=urldecode($rows[$i]['pc_desc'])?>" ></textarea>




                                        <?php $pc_desc11 = urldecode($rows[$i]['pc_desc']); ?>
