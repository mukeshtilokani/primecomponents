...
<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header">
      <?= urldecode( htmlspecialchars_decode( $jsonProdData[0]->p_title ) ) ?>
    </h1>
  </div>
  <?php
  ...
  <div class="col-lg-3 col-md-4 col-xs-6 thumb"> <a href="#" class="thumbnail"> <img alt=""
									     src="<?= SITEURLFRONT ?>images/products/medium/<?= urldecode( htmlspecialchars_decode( $valueProdData1->pi_image ) ) ?>"
									     class="img-responsive"> </a>
    <div> <a  data-id="<?=$valueProdData1->pi_id?>" data-pid="<?=$valueProdData1->p_id?>"   class="btn btn-primary mainImg" ><span class="fa fa-pencil"></span> Set Main Image</a> </div>
    <div> <a  data-id="<?=$valueProdData1->pi_id?>" data-pid="<?=$valueProdData1->p_id?>"   class="btn btn-danger delImg" ><span class="fa fa-trash"></span> Delete</a> </div>
  </div>
  <?php } ?>
  <script>
						...
						url: '../../api/product/deleteImage.php',
						success: function (data) {
  ...
  <div class="col-lg-12 col-md-12 col-xs-12">
    <div class="alert alert-danger"> No images uploaded. </div>
  </div>
  <?php 	} ?>
</div>
<?php }
