	...
	header('Content-Type: application/json');
	  ...
	  try {
		...
		/*** INSERT data ***/
		  ...
		  $p_imageNameNew =  $_POST['p_imageName'];
		  $p_imageAddRemove = $p_imageNameOld;

		  if( strlen($p_imageNameNew) > 0)
		  {
			  $p_imageAddRemove = $p_imageNameNew;
		  }
		  ...
		  $stmt->bindParam(':p_image',  $p_imageAddRemove);
		  ...
		  if( strlen($p_imageNameNew) > 0)
		  {
			  ...
			  //$p_imageRemove = $p_imageNameOld;
			  //delete old images
			/*  $images =  explode(",", urldecode($p_imageRemove));
