var FormValidator = function () {
    ...
    var saveForm = function(){
        ...
        var pgl_alias = encodeURIComponent($("#pc_alias1").val());
        var pgl_title = encodeURIComponent($("#pc_title1").val());

        var pgl_images = encodeURIComponent($("#p_imageName").val());
        ...
        $.ajax({
            ...
            data: {
                ...
                pgl_alias:pgl_alias,
                pgl_title:pgl_title,
                pgl_images: pgl_images

            },

            url:'../../api/photogallery/save.php',
