        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="footer-logo"><a href="<?=SITEURL?>" title="Logo"><img src="images/footer-logo.png" alt="logo"></a></div>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4">
                    ...
                    <ul class="links">
                        ...
                        <li ><a href="<?= SITEURL ?><?= $rows[ $i ]['wp_alias'] ?>" > <?= urldecode( $rows[ $i ]['wp_title'] ) ?>  </a> </li>
	                ...
	                <ul class="links">
		                <?php  $dbh = new PDO($dsn, $username, $password);
			                ...
			                for($j=0;$j < count($rows1); $j++)
			                {
				                ...
				                ?>
				                <li > <a href="<?=SITEURL?>category/<?=$rows1[$j]['pc_alias']?>">
