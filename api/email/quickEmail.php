...
$mail->setFrom('maulik@shivamnetwork.com', 'Administrator');

//Set an alternative reply-to address

$mail->addReplyTo('maulik@shivamnetwork.com', 'Administrator');

//Set who the message is to be sent to

$mail->addAddress('maulik@shivamnetwork.com', 'Administrator');
  ...
  Visitor details are as follows :<br><br>
   ...
   <div style="padding:10px 20px 20px 20px; color:#424242; ">
        ...
        <div style="display:table-row"> 
          ...
          <div style="display:table-cell"><strong>Comments</strong> </div>
...
$mail->setFrom('maulik@shivamnetwork.com', 'Prime Components');

//Set an alternative reply-to address

$mail->addReplyTo('maulik@shivamnetwork.com', 'Prime Components');
